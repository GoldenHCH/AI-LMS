...
- **SOLO-gate depth by objective verb:** remember/understand → single self-contained concept, no forced synthesis; analyze or above → mandatory synthesis section with ≥2 cross-links to related pages. Don't let a high-level objective get shallow single-concept treatment (F6 rule 3).
